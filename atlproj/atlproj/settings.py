"""
Django settings for atlproj project.
...
SECRET_KEY = 'fh@76_ix+w0z$a8q51$fxr%r+w%(m7w4=o)t%&!y6%280#bvgu'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'ideas/templates/ideas'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = '/ideas/login/google-oauth2/'
